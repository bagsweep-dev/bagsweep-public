...
///         V4_SWAP command. This lets the V2-shaped protocol contracts buy $SWEPT
///         from its launchpad-graduated V4 pool (USDG-curve pmav pool: a direct
///         USDG -> SWEPT hop) WITHOUT modifying any audited code: sanction this
...
contract SweepRouterV4Adapter is Ownable, ReentrancyGuard {
    ...
    ///         both directions. For $SWEPT: the launchpad-graduated pool's exact
